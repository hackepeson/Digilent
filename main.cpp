...
void initADC()
{
    ...
    FDwfAnalogInTriggerAutoTimeoutSet(hdwf, 4.0);
    ...
    FDwfAnalogInTriggerPositionSet(hdwf,0.0003);
...
void initDAC()
{
    ...
    FDwfAnalogOutNodeAmplitudeSet(hdwf, idxChannel, AnalogOutNodeCarrier, 4);
